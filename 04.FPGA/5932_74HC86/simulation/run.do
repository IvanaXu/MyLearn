...
quietly set PROJECT_DIR "D:/Actelprj/TRY/5932_74HC86.v"
...
vlog -work postlayout "${PROJECT_DIR}/designer/impl1/HC86_ba.v"
vlog "+incdir+${PROJECT_DIR}/stimulus" -work postlayout "${PROJECT_DIR}/stimulus/testbench86.v"

vsim -L proasic3 -L postlayout  -t 1ps -sdfmax /u1=${PROJECT_DIR}/designer/impl1/HC86_ba.sdf postlayout.testbench
add wave /testbench/*
run 80ns
