...
quietly set PROJECT_DIR "D:/Actelprj/1209/5932_74HC194"
...
vlog -work postlayout "${PROJECT_DIR}/designer/impl1/HC194_ba.v"
vlog "+incdir+${PROJECT_DIR}/stimulus" -work postlayout "${PROJECT_DIR}/stimulus/textbench194.v"

vsim -L proasic3 -L postlayout  -t 1ps -sdfmax /u1=${PROJECT_DIR}/designer/impl1/HC194_ba.sdf postlayout.testbench
add wave /testbench/*
run 500ns
