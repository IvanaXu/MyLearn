...
quietly set PROJECT_DIR "D:/Actelprj/5932/5932_74HC00"
...
vlog -work postlayout "${PROJECT_DIR}/designer/impl1/HC00_ba.v"
vlog "+incdir+${PROJECT_DIR}/stimulus" -work postlayout "${PROJECT_DIR}/stimulus/testbench00.v"

vsim -L proasic3 -L postlayout  -t 1ps -sdfmax /u1=${PROJECT_DIR}/designer/impl1/HC00_ba.sdf postlayout.testbench
add wave /testbench/*
run 80ns
