...
quietly set PROJECT_DIR "D:/Actelprj/1128/5932_74HC283"
...
vlog -work postlayout "${PROJECT_DIR}/designer/impl1/HC283_ba.v"
vlog "+incdir+${PROJECT_DIR}/stimulus" -work postlayout "${PROJECT_DIR}/stimulus/testbench283.v"

vsim -L proasic3 -L postlayout  -t 1ps -sdfmax /u1=${PROJECT_DIR}/designer/impl1/HC283_ba.sdf postlayout.testbench
add wave /testbench/*
run 400ns
